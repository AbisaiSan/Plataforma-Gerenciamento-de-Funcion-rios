...
class UserController extends Controller
{
    ...
    public function store(UserStoreRequest $request)
    {
        ...
        return redirect()->route('users.index')->with('message','User Register sucessfully');
    }
    ...
    public function destroy(User $user)
    {
        if(auth()->user()->id == $user->id){
            return redirect()->route('users.index')->with('message', 'Você deseja excluir esse usuário?');
        }
        $user->delete();
