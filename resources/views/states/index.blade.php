    ...
    <div class="row">
        <div class="card mx-auto">
            ...
            <div class="card-header">
                ...
                <div>
                    <a href="{{ route('states.create') }}" class=" float-right btn btn-primary mb-2">Cadastrar</a>
                </div>
                     ...
                     @foreach ($states as $state )
                        <tr>
                            <th scope="row">{{$state->id}}</th>
                             <td>{{ $state->pais->codigo_pais }}</td>
                            <td >{{$state->name}}</td>
                            <td>
                                <a href="{{route('states.edit', $state->id) }}" class="btn btn-success">Editar</a>
                            </td>
                            <td>
